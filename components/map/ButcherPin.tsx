...
export const ButcherPin = memo(function ButcherPin({
  ...
  return (
    ...
    >
      ...
      <div className="pin-dot place-items-center h-6 w-6 rounded-full border-2 bg-surface border-oxblood text-oxblood shadow-md">
      ...
      <div className={`pin-tag h-2 w-0.5 ${selected ? "bg-oxblood-strong" : "bg-oxblood/70"}`} />
    </div>
  );
});
